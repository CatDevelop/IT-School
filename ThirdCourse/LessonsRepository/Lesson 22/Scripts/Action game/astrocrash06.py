...
class Asteroid(games.Sprite):
    ...
    def die(self):
        ...
        # уничтожить распавшийся астероид
        self.destroy()
...
class Ship(games.Sprite):
    ...
    def update(self):
        ...
        # проверка на перекрытие корабля с другими объектами
...
class Missile(games.Sprite):
    ...
    def update(self):
        ...
        # проверка на перекрытие ракеты с другими объектами
        if self.overlapping_sprites:
            for sprite in self.overlapping_sprites:
                sprite.die()
            self.die()
